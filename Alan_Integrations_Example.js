...
question('what is this', p =>  {
    p.play('This is a news app with voice capabilities. (Powered by Alan|Voice support is provided by Alan)');
});
...
question('what (platforms|SDK|frameorks) are supported', p => {
