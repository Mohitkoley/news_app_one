...
import 'package:news_app_one/controller/fetchpublisher.dart';
import 'package:news_app_one/model/headline.dart';
import 'package:news_app_one/views/detailpage.dart';
import "dart:ui" as ui;

class NewsbyPublishers extends GetWidget {
  FetchPublisher fetchPublisher = Get.put(FetchPublisher());
  String domain;
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        body: FutureBuilder(
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              ...
              return ListView.builder(
                key: PageStorageKey<String>("Publishers"),
          ...
          future: fetchPublisher.fetchcat(domain),
        ),
      ),
    );
  }
